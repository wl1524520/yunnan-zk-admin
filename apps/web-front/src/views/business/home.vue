...
const sections = ref([
  { title: '考试计划', path: '/exam-plans', endpoint: '/exam-plans', total: 0 },
  { title: '学生档案', path: '/students', endpoint: '/students', total: 0 },
]);
const greeting = computed(() => `你好，${userStore.userInfo?.realName || '老师'}`);
...
<template>
  <Page :title="greeting" description="查看当前管理范围内的考试计划和学生档案。">
